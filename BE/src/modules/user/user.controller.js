...
var UserController = (function () {
  ...
  var UserController = (_classThis = /** @class */ (function () {
    function UserController_1(userService, authService) {
      this.userService =
        (__runInitializers(this, _instanceExtraInitializers), userService);
    ...
    UserController_1.prototype.updateById = function (
      requestBody,
      id,
      currentUser,
    ) {
  ...
  (function () {
    ...
    _getCurrentUser_decorators = [
      (0, common_1.Get)('current-user'),
      (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    ];
    _updateById_decorators = [
    ...
    __esDecorate(
      ...
      _updateById_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'updateById' in obj;
          },
          get: function (obj) {
            return obj.updateById;
          },
        },
        metadata: _metadata,
      },
